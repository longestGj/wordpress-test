...
- The stage now runs reviewed code `e3ccb160c891548e40e9a050aa8f51f618f835ca` from its own release directory. It imported 14 products, seven root pages, seven process/application pages, eight resources, three document guides, 11 market pages, and Contact/Thank You/Cookie Policy/English and Malay Privacy pages. Repeat bootstrap preserved existing pages and the administrator password.
- The final stage HTTP check returned 200 for Home, Products, M-350, Applications, Resources, REACH, all 11 market pages, and the five utility pages; unknown URLs and RFQ returned 404. The starter Sample Page was removed. The stage Home has `noindex, nofollow`, WordPress loopback returns 200, and both stage containers are healthy. The public domain still returns old release `bed69fff43a5e26b441154ffe4f4f44df11a319b`.
