...
Sulfate durable industrial, powder, and architectural coatings grade.

## 内容与事实

- [Current content input](<../inputs/pages/products/detail-template/06_handoff/GRADE-M996_PRODUCT_DETAIL_CONTENT_CONTRACT_V0.1.json>)
- [WordPress initialization seed](../../data/products/m-996.json) — initialization only; preserve live editor changes.
...
Keyword boundary: This page owns M-996 model intent only; Applications owns generic use-case intent; process pages own generic process intent.
