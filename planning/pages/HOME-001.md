...
The updated main branch was republished on 2026-09-23 after a verified production backup. The guarded Home and navigation migrations applied once and reported no pending changes on a repeat run. Public Home, navigation, SEO, schema, grade links, three viewport sizes and full-site route checks passed. See the [production release record](../../docs/audits/production-release-2026-09-23.md).
