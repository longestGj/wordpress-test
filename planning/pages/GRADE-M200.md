...
Durable exterior plastics grade for uPVC and PVC film applications.

## 内容与事实

- [Current content input](<../inputs/pages/products/detail-template/06_handoff/GRADE-M200_PRODUCT_DETAIL_CONTENT_CONTRACT_V0.2.json>)
- [WordPress initialization seed](../../data/products/m-200.json) — initialization only; preserve live editor changes.
...
Keyword boundary: This page owns M-200 model intent only; Applications owns generic use-case intent; process pages own generic process intent.
