...
Sulfate industrial and powder coatings grade; publish differentiation from M-996 only when verified.

## 内容与事实

- [Current content input](<../inputs/pages/products/detail-template/06_handoff/GRADE-M2196_PRODUCT_DETAIL_CONTENT_CONTRACT_V0.1.json>)
- [WordPress initialization seed](../../data/products/m-2196.json) — initialization only; preserve live editor changes.
...
Keyword boundary: This page owns M-2196 model intent only; Applications owns generic use-case intent; process pages own generic process intent.
