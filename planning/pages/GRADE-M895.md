...
Architectural and industrial coatings grade.

## 内容与事实

- [Current content input](<../inputs/pages/products/detail-template/06_handoff/GRADE-M895_PRODUCT_DETAIL_CONTENT_CONTRACT_V0.1.json>)
- [WordPress initialization seed](../../data/products/m-895.json) — initialization only; preserve live editor changes.
...
Keyword boundary: This page owns M-895 model intent only; Applications owns generic use-case intent; process pages own generic process intent.
