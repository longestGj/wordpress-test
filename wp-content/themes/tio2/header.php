...
<a class="logoLink" href="<?php echo esc_url(home_url('/')); ?>" aria-label="TiO2 Malaysia — Home"><img class="logo" src="<?php echo esc_url(get_template_directory_uri().'/assets/logo.svg'); ?>" alt="TiO2 Malaysia" width="180" height="60"></a>
