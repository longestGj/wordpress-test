...
if(function_exists('tio2_is_resource_page')&&tio2_is_resource_page($id)){tio2_render_resource_page($id);}
elseif($key){echo '<main id="main" tabindex="-1" class="'.esc_attr(get_post_meta($id,'_tio2_main_class',true)).'">'.tio2_hub_content($id).'</main>';}
