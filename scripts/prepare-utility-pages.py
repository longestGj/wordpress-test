...
<section class="wrap"><h2>General contact details</h2><p>For a general question about the company or another business matter, use the form on this page. You can also find the General Inquiries email, Operating Company and Manufacturing Site below.</p><div class="utility-card-grid"><div class="utility-card"><h3>General Inquiries</h3><a href="mailto:info@tio2malaysia.com">info@tio2malaysia.com</a></div><div class="utility-card"><h3>Operating Company</h3><p>IKHLAS TITANIUM (MALAYSIA) SDN. BHD.</p></div><div class="utility-card"><h3>Manufacturing Site</h3><p>NO.33 Industrial Perusahaan Ringan Tupai, 34000 Taiping, Perak, Malaysia</p></div></div></section>
